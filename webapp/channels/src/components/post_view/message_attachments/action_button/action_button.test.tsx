...
describe('components/post_view/message_attachments/action_button.jsx', () => {
    ...
    test('should have correct styles when provided color from theme', () => {
        ...
        expect(button).toHaveStyle(`background-color: ${changeOpacity(Preferences.THEMES.ik.onlineIndicator, 0.08)}`);
        expect(button).toHaveStyle(`color: ${Preferences.THEMES.ik.onlineIndicator}`);
    });
