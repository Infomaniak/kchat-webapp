            ...
            if (pageEnd < this.props.total) {
                nextButton = (
                    <button
                        ...
                        className='btn btn-sm btn-tertiary secondary filter-control filter-control__next'
            ...
            if (this.props.page > 0) {
                previousButton = (
                    <button
                        ...
                        className='btn btn-sm btn-tertiary secondary filter-control filter-control__prev'
