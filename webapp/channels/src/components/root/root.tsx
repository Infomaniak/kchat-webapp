...
const LazyAdminConsole = Utils.lazyWithRetries(() => import('components/admin_console'));
const LazyLoggedIn = Utils.lazyWithRetries(() => import('components/logged_in'));
const LazyPasswordResetSendLink = Utils.lazyWithRetries(() => import('components/password_reset_send_link'));
const LazyPasswordResetForm = Utils.lazyWithRetries(() => import('components/password_reset_form'));
const LazySignup = Utils.lazyWithRetries(() => import('components/signup/signup'));
const LazyTermsOfService = Utils.lazyWithRetries(() => import('components/terms_of_service'));
const LazyShouldVerifyEmail = Utils.lazyWithRetries(() => import('components/should_verify_email/should_verify_email'));
const LazyDoVerifyEmail = Utils.lazyWithRetries(() => import('components/do_verify_email/do_verify_email'));
const LazyClaimController = Utils.lazyWithRetries(() => import('components/claim'));
const LazyLinkingLandingPage = Utils.lazyWithRetries(() => import('components/linking_landing_page'));
const LazySelectTeam = Utils.lazyWithRetries(() => import('components/select_team'));
const LazyAuthorize = Utils.lazyWithRetries(() => import('components/authorize'));
const LazyCreateTeam = Utils.lazyWithRetries(() => import('components/create_team'));
const LazyMfa = Utils.lazyWithRetries(() => import('components/mfa/mfa_controller'));
...
const LazyDelinquencyModalController = Utils.lazyWithRetries(() => import('components/delinquency_modal'));
