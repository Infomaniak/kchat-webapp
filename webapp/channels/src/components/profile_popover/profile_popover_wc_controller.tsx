...
export const ProfilePopoverWcController = React.forwardRef<WcContactSheetElement | undefined, ProfilePopoverProps>((props: ProfilePopoverProps, ref: ForwardedRef<WcContactSheetElement | undefined>) => {
    const {
        disabled,
        username,
        hideStatus,
