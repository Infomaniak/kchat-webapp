...
export function deleteScheduledPost(userId: string, scheduledPostId: string) {
    return async (dispatch: DispatchFunc) => {
        try {
            const deletedScheduledPost = await Client4.deleteScheduledPost(userId, scheduledPostId);
