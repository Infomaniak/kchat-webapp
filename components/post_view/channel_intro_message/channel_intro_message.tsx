                ...
                {teammate?.username === 'kchat.bot' ? (
                    <p className='channel-limitation-banner'>
                        ...
                        <FormattedMarkdownMessage
                            ...
                            values={{botName: 'kchat.bot'}}
                            defaultMessage='{botName} is a sovereign AI. The data is processed exclusively in Switzerland on Infomaniak’s servers. We remind you that the information generated by {botName} and AI may be inaccurate, incomplete or misleading.'
                        />
                    </p>
                ) : null}
            </div>
