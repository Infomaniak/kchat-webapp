...
export async function refreshIKToken(redirectToTeam = false): Promise<{token: string; refreshToken: string; expiresAt: number}> {
    ...
    } else if (!isServerVersionGreaterThanOrEqualTo(getDesktopVersion(), '2.0.2')) {
