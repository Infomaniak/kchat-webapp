...
if (DEV) {
    ...
    env.BASE_URL = JSON.stringify(process.env.BASE_URL || 'https://kchat.infomaniak.com/'); //eslint-disable-line no-process-env
    ...
    config = {
        ...
        devServer: {
            ...
            proxy: [{
                ...
                logLevel: 'silent',
                target: env.BASE_URL, //eslint-disable-line no-process-env
                changeOrigin: true,
                xfwd: true,
                ws: true,
            }],
